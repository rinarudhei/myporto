...
export const PortofolioCard = ({
  ...
  return (
    <Card className='w-90.25 xl:w-96.75'>
      <div className='flex-center relative flex-col gap-2 rounded-4xl bg-neutral-100 p-4'>
        <div className='relative h-82.25 w-82.25 xl:h-88.75 xl:w-88.75'>
          <Image
            src={imageUrl}
        ...
        <Image
          ...
          width={97}
          height={29}
          className='absolute right-1/2 bottom-1/2 -translate-x-23 -translate-y-31 xl:-translate-x-[104.75px] xl:-translate-y-34'
        />
      </div>
      <CardFooter className='flex-center w-full'>
        <div className='flex-center w-full justify-between'>
          <div className='flex w-90.25 flex-col gap-3 xl:w-79.75'>
